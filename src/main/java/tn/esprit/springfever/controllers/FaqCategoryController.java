...
import tn.esprit.springfever.Services.Interface.IServiceFaqCategory;
...
@RestController
@RequestMapping(value = "/faq-categories" , produces = "application/json" , consumes = "application/json")
