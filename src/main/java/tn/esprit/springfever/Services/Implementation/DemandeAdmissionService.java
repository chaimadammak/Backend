...
public class DemandeAdmissionService {
    ...
    public void Tuteurdispo(Long demandeid) throws JsonProcessingException {
        ...
        List<User> users = userRepo.findByEtatUser("disponible");
    ...
    private DemandeAdmission mapToEntity( DemandeAdmissionDTO demandeAdmissionDTO,
        ...
        User condidat = demandeAdmissionDTO.getCondidat() == null ? null : demandeAdmission.getCondidat();

        demandeAdmission.setCondidat(condidat);

        User evaluateur = demandeAdmissionDTO.getEvaluateeur() == null ? null :demandeAdmission.getEvaluateur();
