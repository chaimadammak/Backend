...
import tn.esprit.springfever.dto.UserDTO;
  import tn.esprit.springfever.Services.Interface.JobMapper;
...
public class JobRdvService implements IJobRDV {
    ...
    public String AssignJobApplicationAndJuryToRDV(Long Id_Job_Application, Long ID_Job_DRV, Long idJury) {
        ...
        try {
            ...
            jury = userRepo.findById(idJury).get();
        } catch (Exception e) {
    ...
    public void findFirstAvailableDateTime(Long dispoCandidate, Long dispoJury, int interviewDuration) {
        ...
        System.out.println("C est bon1");

        Long idJury =disponiblityJury.getJobRDV().getJury().getUserid();
        System.out.println("C est bon2++++++++++++++++++++++++++++++++++++++++++++++++++++++++"+ idJury);
        Job_RDV jobRdv = jobRdvRepository.findJob_RDVByJuryUserid(idJury);
    ...
    public void sendEmailToFIXRDV(Long id, String subject, String body) throws JsonProcessingException {
        ...
        String to = (job_application.getUserjobapp().getEmail());
