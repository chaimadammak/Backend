...
import tn.esprit.springfever.dto.TeamsResponse;
 import tn.esprit.springfever.Services.Interface.TeamsMapper;
import tn.esprit.springfever.Services.Interface.IServiceTeams;
...
public class ServiceTeamsImpl implements IServiceTeams{
    ...
    public String AssignImageToTeams(Long idTeam , Long id ){
        ...
        Image image=imageDataRepository.findById(id).orElse(null);
...
*/
    ...
    /*
    @Override
    public List<TeamsResponse> getAllTeams() {return convertToResponse(teamsRepository.findAll());}
